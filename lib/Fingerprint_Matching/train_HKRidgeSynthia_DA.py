...
from datasets.RidgeBase_HKPolyU_Synthia import RidgeBase_HKPolyU_Synthia
...
def test_EER(model, device, test_loader, epoch):
    ...
    print("IS REPEATING: ", len(set(cb_fnames)))
...
def main():
    ...
    train_dataset    = RidgeBase_HKPolyU_Synthia(args.ccr, split="train")
    # val_dataset      = Syntha_HKPolyU(args.ccr, split="val")
    test_dataset     = RidgeBase_HKPolyU_Synthia(args.ccr, split="test")
    ...
    ckpt = torch.load("/home/bhavinja/GradioDemoFingerprint/updated_demo/lib/Fingerprint_Matching/Models/hkpoly_BS64LR001_2024_MarginThreshold_MSDALoss_ALLDATA_tightCrop_loss1_63_0.7329545454545454.pt", map_location=torch.device('cpu'))
