...
from datasets.hkpolyu_pair import HKPolyU_Pair
...
from model import SwinModel_TPS as Model
...
def main():
    ...
    train_dataset    = HKPolyU_Pair(args.ccr, split="train")
    val_dataset      = HKPolyU_Pair(args.ccr, split="test")
    ...
    optimizer_swin = optim.Adam(
        [
            ...
            {"params": model.swin_cb.parameters(), "lr":args.lr},
            {"params": model.tps.parameters(),     "lr":args.lr}
        ],
        lr=args.lr)
